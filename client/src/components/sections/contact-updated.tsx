            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input 
                  ...
                  required
                  className="w-full glass border border-white/10 rounded-lg px-4 py-3 text-text-primary focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent/50 transition-colors" 
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  required
                  rows={5} 
                  className="w-full glass border border-white/10 rounded-lg px-4 py-3 text-text-primary focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent/50 transition-colors resize-none" 
                />
              </div>
